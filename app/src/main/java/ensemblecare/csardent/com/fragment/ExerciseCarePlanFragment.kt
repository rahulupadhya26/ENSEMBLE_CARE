...
import ensemblecare.csardent.com.adapters.CarePlanExerciseTaskListAdapter
...
import ensemblecare.csardent.com.databinding.FragmentExerciseCarePlanBinding
    ...
    private fun updateExerciseTodayTasks(exerciseTaskDetails: ArrayList<CareDayIndividualTaskDetail>) {
        binding.recyclerViewCarePlanExerciseTask.apply {
            ...
            adapter = CarePlanExerciseTaskListAdapter(
                mActivity!!,
                exerciseTaskDetails, this@ExerciseCarePlanFragment, this@ExerciseCarePlanFragment
            )
        }
    }
