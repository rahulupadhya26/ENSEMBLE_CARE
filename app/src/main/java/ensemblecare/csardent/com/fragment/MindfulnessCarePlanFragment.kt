...
import ensemblecare.csardent.com.adapters.CarePlanMindfulnessTaskListAdapter
...
import ensemblecare.csardent.com.databinding.FragmentMindfulnessCarePlanBinding
    ...
    private fun updateMindfulnessTodayTasks(mindfulnessTaskDetails: ArrayList<CareDayIndividualTaskDetail>) {
        binding.recyclerViewCarePlanMindfulnessTask.apply {
            ...
            adapter = CarePlanMindfulnessTaskListAdapter(
                mActivity!!,
                mindfulnessTaskDetails, this@MindfulnessCarePlanFragment, this@MindfulnessCarePlanFragment
            )
        }
    }
