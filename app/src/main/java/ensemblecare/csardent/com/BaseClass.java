...
import ensemblecare.csardent.com.controller.AGEventHandler;
import ensemblecare.csardent.com.data.ConstantApp;
import ensemblecare.csardent.com.data.CurrentUserSettings;
import ensemblecare.csardent.com.data.EngineConfig;
import ensemblecare.csardent.com.services.SelfCareApplication;
...
public abstract class BaseClass extends AppCompatActivity {
    private final static Logger log = LoggerFactory.getLogger(BaseClass.class);
    ...
    protected SelfCareApplication application() {
        return (SelfCareApplication) getApplication();
    }
     ...
     * @param uid User ID.
     */
    public final void joinChannel(final String channel, String token, int uid) {
